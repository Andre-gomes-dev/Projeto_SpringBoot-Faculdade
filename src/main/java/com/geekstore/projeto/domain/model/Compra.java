	...
	public void comprar() {	
		...
		String tabela = null;
			...
			do {
				...
				System.out.println("Qual tipo de produto voc� deseja comprar?");
				do {
			...
			do {
				...
				if (quantidade < 1 || quantidade > 10) {
					System.out.println("N�o podemos fornecer a quantidade de produtos desejada.\nPor favor, selecione no m�nimo 1 produto: ");
					parar = false;
				} else {
					parar = true;
				}
			...
			//N�o pode ser igual ou menor a 0
		...
		do {
			...
			if (this.formaPagamento == 'c' || this.formaPagamento == 'C') {
				System.out.println("Voc� quer pagar em quantas vezes?");
				...
				System.out.printf("O valor total da compra �: R$ %.2f", this.valorTotal);
				this.setValorTotal(this.valorTotal);
				parar = true;
			} else {
				System.out.println("Escolha uma op��o de pagamento v�lida");
				parar = false;
			}
